...
# outputs, _, _ = tf.contrib.rnn.stack_bidirectional_rnn(stacked_fw_rnn, stacked_bw_rnn, x1, dtype=tf.float32)
...
outputs, _, _ = tf.contrib.rnn.stack_bidirectional_rnn([mcell_fw], [mcell_bw], x1, dtype=tf.float32)
